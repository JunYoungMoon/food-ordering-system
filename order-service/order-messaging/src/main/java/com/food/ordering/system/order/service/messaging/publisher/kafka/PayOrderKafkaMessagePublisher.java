    ...
    public void publish(OrderPaidEvent domainEvent) {
        ...
        try {
            ...
            future.whenComplete((result, throwable) -> {
                if (throwable != null) {
                    kafkaMessageHelper.handleFailure(orderId, restaurantApprovalRequestAvroModel, throwable);
                } else {
                    kafkaMessageHelper.handleSuccess(orderId, restaurantApprovalRequestAvroModel, result);
                }
            });
