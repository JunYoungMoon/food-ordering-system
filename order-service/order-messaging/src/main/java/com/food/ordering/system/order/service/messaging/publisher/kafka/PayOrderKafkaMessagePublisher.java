    ...
    public void publish(OrderPaidEvent domainEvent) {
        ...
        try {
            ...
            future.whenComplete((result, throwable) -> {
                if (throwable != null) {
                    orderKafkaMessageHelper.handleFailure(orderId, restaurantApprovalRequestAvroModel, throwable);
                } else {
                    orderKafkaMessageHelper.handleSuccess(orderId, restaurantApprovalRequestAvroModel, result);
                }
            });
